...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when the previous step is 10' do
      it 'returns 2' do
        expect(game2.subtract_random_number(10)).to eq(2)
      end
    end
  end
  ...
  describe '#play' do
    ...
    context 'when the random number is 14' do
      subject(:game3) { described_class.new(14) }
      # remove the 'x' before running this test
      it 'will return 7' do
    ...
    context 'when the random number is 97' do
      subject(:game4) { described_class.new(97) }
      # remove the 'x' before running this test
      it 'will return 7' do
        expect(game4.play).to eq(7)
      end
    end
  end
end
